...
def _xcode_config_impl(ctx):
    ...
    ios_sdk_version = _dotted_version_or_default(xcode_version_properties.default_ios_sdk_version, "15.0")
    macos_sdk_version = _dotted_version_or_default(xcode_version_properties.default_macos_sdk_version, "12.0")
    tvos_sdk_version = _dotted_version_or_default(xcode_version_properties.default_tvos_sdk_version, "15.0")
    watchos_sdk_version = _dotted_version_or_default(xcode_version_properties.default_watchos_sdk_version, "9.0")
